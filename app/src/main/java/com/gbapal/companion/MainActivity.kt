...
import com.gbapal.companion.ui.anchors.AnchorScreen
import com.gbapal.companion.ui.diff.DiffScannerScreen
import com.gbapal.companion.ui.dexnav.DexNavScreen
import com.gbapal.companion.ui.hub.HubScreen
import com.gbapal.companion.ui.inspector.InspectorScreen
import com.gbapal.companion.ui.theme.PixelText
import com.gbapal.companion.ui.theme.RetroPanel
...
private fun DevTools(onClose: () -> Unit) {
    ...
    Column(modifier = Modifier.fillMaxSize().background(RetroTheme.background)) {
        RetroPanel(modifier = Modifier.fillMaxWidth().padding(8.dp)) {
            Column {
                PixelText("GBA PAL // DEVELOPER TOOLS", color = RetroTheme.text)
                PixelText(
